      ...
      <main className="flex items-center justify-center px-6 py-20">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-startup border border-landing-outline-variant/10 p-8">
            ...
            <p className="text-xs text-center text-landing-secondary mb-6">
              By continuing, you agree to our{" "}
              <Link to="/terms" className="text-landing-primary hover:underline" target="_blank">
                Terms
              </Link>{" "}
              and{" "}
              <Link to="/privacy" className="text-landing-primary hover:underline" target="_blank">
                Privacy Policy
              </Link>
            </p>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-landing-secondary">or register with email</span>
              </div>
            </div>
